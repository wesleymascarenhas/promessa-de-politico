var _nodeEnv = process.env.NODE_ENV || 'dev',
    ...
    _publicPath = '/home/sandro/workspace/promessa-de-politico/public',
    _database = {
      dev: {
        dialect: 'mysql',
        host: 'localhost',
    ...
    _facebook = {
      dev: {
        ...
        callbackURL: 'http://www.promessadepolitico.com.br:3000/auth/facebook/callback'
      }
    },
    _twitter = {
      dev: {
        ...
        callbackURL: 'http://www.promessadepolitico.com.br:3000/auth/twitter/callback'
      }
    },
    _google = {
      dev: {
        ...
        callbackURL: 'http://www.promessadepolitico.com.br:3000/auth/google/callback'
      }
    }
